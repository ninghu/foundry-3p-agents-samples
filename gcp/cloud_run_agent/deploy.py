...
"""Build and deploy the Cloud Run exchange rate agent."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build and deploy the Cloud Run exchange rate agent.",
    )
    parser.add_argument(
        "--env-file",
        type=Path,
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Allow unauthenticated invocation of the Cloud Run service.",
    )
    parser.add_argument(
        "--extra-env",
        default=None,
